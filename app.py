...
def send_inquiry_email(form_data):
    try:
        ...
        receiver_email = "aqarinfo46@gmail.com"
        ...
        with smtplib.SMTP_SSL("smtp.gmail.com", 465) as server:
            server.login("aqarinfo46@gmail.com", "wtsbiqvqfexcmnxq")
...
st.markdown('For inquiries, please contact us @ Mobile Number -  01098470144 ', unsafe_allow_html=True)
